...
# Some columns were not meant to be used to decide, such as their Employee ID number
...
# The minimum error comes when cp = 0.00077640 and 45 splits
pruned_tree <- prune(full_tree, cp = 0.00077640)
...
# Plotting the ROC curve. Areas under the curve: 0.985
